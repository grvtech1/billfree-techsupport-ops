...
/**
 * [P1-FIX] RISK-07: validateCSRFTokenEnhanced was called by both validateCSRFToken()
 * and requireCSRFToken() but was NEVER DEFINED — causing ReferenceError on every
 * write operation at runtime.
 *
 * This implementation:
 ...
 */
// [W1-1 FIX] Freeze VALIDATION_SCHEMAS — prevents accidental runtime mutation
// (previously a plain var object mutable from any scope).
